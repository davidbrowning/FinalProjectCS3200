...
public class DairyActivity extends ListActivity {
    ...
    public void onListItemClick(ListView listView,
        ...
        if(position != listView.getLastVisiblePosition()) {
            Intent intent = new Intent(DairyActivity.this, InventoryActivity.class);
            Bundle bundle = new Bundle();
            bundle.putInt(InventoryActivity.EXTRA_DRINKNO, (int) id);
            bundle.putInt(InventoryActivity.EXTRA_TID, 4);
            intent.putExtras(bundle);
            startActivity(intent);
        }
        else{
            Intent intent = new Intent(DairyActivity.this, BarcodeSetup.class);
            final int tid = 4;
            Bundle bundle = new Bundle();
            bundle.putInt(InventoryActivity.EXTRA_DRINKNO, (int) id);
            bundle.putInt(InventoryActivity.EXTRA_TID, 4);
    ...
    private static void insertThing(SQLiteDatabase db, String name,
        ...
        db.insert("DAIRY", null, drinkValues);
    }
}
